# adf-widget-ja-zconnect-widget-user

ja-zconnect-widget-user widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-ja-zconnect-widget-user
...
```html
<script type="text/javascript" src="path/to/ja-zconnect-widget-user.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'ja-zconnect-widget-user']);
```
