...
$templateCache.put("{widgetsPath}/ja-zconnect-widget-user/src/templates/group/listgroup.html","<div><ul><li data-ng-if=\"groups.total > 0\" data-ng-repeat=\"gro in groups.groupslist\"><a data-ng-href=\"index.php?option=com_community&view=groups&task=viewgroup&groupid={{gro.id}}\"><span><img ng-src=/{{gro.thumb}}></span> <span data-ng-bind=gro.name></span></a> <span data-ng-bind=gro.date_created></span></li><li data-ng-if=\"groups.total==0\"><p class=no_suggestion_p>No group at the moment.</p></li></ul><uib-pagination data-ng-if=\"groups.total > 0\" items-per-page=groups.limit total-items=groups.total ng-model=groups.page max-size=5 class=pagination-sm boundary-link-numbers=true data-ng-change=\"groups.paginationChanged(groups.limit, groups.page)\"></uib-pagination></div>");
$templateCache.put("{widgetsPath}/ja-zconnect-widget-user/src/templates/group/mygrouplist.html","<div><ul><li data-ng-if=\"groups.total > 0\" data-ng-repeat=\"gro in groups.mygrouplist\"><a data-ng-href=\"index.php?option=com_community&view=groups&task=viewgroup&groupid={{gro.id}}\"><span><img ng-src=/{{gro.thumb}}></span> <span data-ng-bind=gro.name></span></a> <span data-ng-bind=gro.created></span></li><li data-ng-if=\"groups.total==0\"><p class=no_suggestion_p>No group at the moment.</p></li></ul><uib-pagination data-ng-if=\"groups.total > 0\" items-per-page=groups.limit total-items=groups.total ng-model=groups.page max-size=5 class=pagination-sm boundary-link-numbers=true data-ng-change=\"groups.paginationChanged(groups.limit, groups.page)\"></uib-pagination></div>");
...
$templateCache.put("{widgetsPath}/ja-zconnect-widget-user/src/templates/message/listmymessage.html","<div><ul><li data-ng-if=\"message.total > 0\" data-ng-repeat=\"mess in message.mymessage\"><div></div><a data-ng-href=\"/index.php?option=com_zconjobs&view=profile&Itemid=688&lang=en#/{{message.currentUser.user_id}}\"><span data-ng-bind=mess.from_name></span></a> <a data-ng-href=\"/index.php?option=com_community&view=inbox&task=read&msgid={{mess.id}}&Itemid=638&lang=en\"><span data-ng-bind=mess.subject></span></a> <span data-ng-bind=mess.posted_on></span></li><li data-ng-if=\"message.total==0\"><p class=no_suggestion_p>No Message at the moment.</p></li></ul><uib-pagination data-ng-if=\"message.total > 0\" items-per-page=message.limit total-items=message.total ng-model=message.page max-size=5 class=pagination-sm boundary-link-numbers=true data-ng-change=\"message.paginationChanged(message.limit, message.page)\"></uib-pagination></div>");
$templateCache.put("{widgetsPath}/ja-zconnect-widget-user/src/templates/profile/account.html","<ul class=user_dashbord_personal_info><li><h6>Username :</h6><p data-ng-bind=profile.currentUser.email></p></li><li id=password><h6>Password :</h6><p>******************</p><p><a href=javascript: data-ng-click=profile.showInputPassword()>Edit Password</a></p></li><form name=passwordForm data-ng-submit=profile.editPassword(passwordForm) novalidate id=inputPassword hidden><p>Current Password : <input type=password name=current_password data-ng-model=profile.password.current_password data-ng-required=true></p><span class=error-message data-ng-show=\"passwordForm.current_password.$error.required && (passwordForm.$submitted || passwordForm.current_password.$touched)\">Please fill-up current password.</span> <span class=error-message data-ng-show=\"profile.password.current_password.length < 8\">Invalid current password.</span><p>New Password : <input type=password name=new_password data-ng-model=profile.password.new_password data-ng-required=true></p><span class=error-message data-ng-show=\"passwordForm.new_password.$error.required && (passwordForm.$submitted || passwordForm.new_password.$touched)\">Please fill-up new password.</span> <span class=error-message data-ng-show=\"profile.password.new_password.length < 8\">Password must be 8 above.</span><p>Re-type Password : <input type=password name=retype_password data-ng-model=profile.password.retype_password data-ng-required=true></p><span class=error-message data-ng-show=\"passwordForm.retype_password.$error.required && (passwordForm.$submitted || passwordForm.retype_password.$touched)\">Please fill-up re-type password.</span> <span class=error-message data-ng-show=\"profile.password.retype_password.length < 8\">Password must be 8 above.</span> <span class=error-message data-ng-show=\"profile.not_valid != null\">{{profile.not_valid}}</span><p><input type=submit value=Submit></p><p><button data-ng-click=profile.cancelEditPassword()>Cancel</button></p></form></ul>");
...
$templateCache.put("{widgetsPath}/ja-zconnect-widget-user/src/templates/znetwork/friends.html","<div><div class=\"col-lg-12 col-sm-12 col-xs-12\"><div class=row><ul class=suggested_contacts><li data-ng-repeat=\"friend in znetwork.znetwork\"><div class=\"col-lg-12 col-sm-12 col-xs-12\"><div class=row><div class=col-lg-2><div class=row><a data-ng-href={{friend.profile_url}}><img ng-src={{friend.avatar}}></a></div></div><div class=col-lg-10><div class=row><a data-ng-href={{friend.profile_url}}><p class=contact_name data-ng-bind=\"friend.first_name + \' \' + friend.last_name\"></p></a></div></div></div></div></li></ul><uib-pagination total-items=znetwork.total items-per-page=znetwork.limit data-ng-model=znetwork.page max-size=5 class=pagination-sm boundary-link-numbers=true data-ng-change=\"znetwork.paginationChanged(znetwork.currentUser, znetwork.limit, znetwork.page)\"></uib-pagination></div></div></div>");
