...
$templateCache.put("{widgetsPath}/ja-zconnect-widget-user/src/templates/jobs/listapplied.html","<div><ul><li data-ng-if=\"applied.total > 0\" data-ng-repeat=\"applieds in applied.appliedjobs\"><a data-ng-href={{applieds.job.url}}><span><img ng-src=/{{applieds.job.job_group.company.avatar}}> <span data-ng-bind=applieds.job.job_title></span></span></a> <span data-ng-bind=applieds.job.job_group.country></span> <span data-ng-bind=applieds.job.job_group.industry></span> <span data-ng-bind=applieds.date_applied></span></li><li data-ng-if=\"applied.total==0\"><p class=no_suggestion_p>No Applied Jobs at the moment.</p></li></ul><uib-pagination data-ng-if=\"applied.total > 0\" total-items=applied.total ng-model=applied.page max-size=5 class=pagination-sm boundary-link-numbers=true data-ng-change=\"applied.paginationChanged(applied.currentUser, applied.limit, applied.page)\"></uib-pagination></div>");
...
$templateCache.put("{widgetsPath}/ja-zconnect-widget-user/src/templates/znetwork/friends.html","<div><div class=\"col-lg-12 col-sm-12 col-xs-12\"><div class=row><ul class=suggested_contacts><li data-ng-repeat=\"friend in znetwork.znetwork\"><div class=\"col-lg-12 col-sm-12 col-xs-12\"><div class=row><div class=col-lg-2><div class=row><a data-ng-href={{friend.profile_url}}><img ng-src={{friend.avatar}}></a></div></div><div class=col-lg-10><div class=row><a data-ng-href={{friend.profile_url}}><p class=contact_name data-ng-bind=\"friend.first_name + \' \' + friend.last_name\"></p></a></div></div></div></div></li></ul><uib-pagination total-items=znetwork.total ng-model=znetwork.page max-size=5 class=pagination-sm boundary-link-numbers=true data-ng-change=\"znetwork.paginationChanged(znetwork.currentUser, znetwork.limit, znetwork.page)\"></uib-pagination></div></div></div>");
